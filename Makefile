...
QEMU_OPTS_COMMON= -m $(QEMU_MEMORY) -smp 4 -display none $(QEMU_OPTS_BIOS) \
	...
	-global ICH9-LPC.noreboot=false -watchdog-action reset \
        ...
        -netdev user,id=eth0,net=$(QEMU_OPTS_NET1),dhcpstart=$(QEMU_OPTS_NET1_FIRST_IP),hostfwd=tcp::$(SSH_PORT)-:22$(QEMU_TFTP_OPTS),hostfwd=tcp::2345-:2345 -device virtio-net-pci,netdev=eth0,romfile="" \
